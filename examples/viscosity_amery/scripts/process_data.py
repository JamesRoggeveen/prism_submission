...
if __name__ == "__main__":
    data = loadmat("data/original_amery.mat")
    ...
    h_phys, u_phys, v_phys = h_data["data"], u_data["data"], v_data["data"]
    ...
    L0, H0 = np.max(np.array([x_range, y_range])), h_range
    U0 = u_range / 2.0
    if U0 < 1e-9:
        U0 = 1.0
    ...
    field_data = {"h":h_data,"u":u_data,"v":v_data}
    ...
    full_data_dict = {"bc": bc_data, "fields": field_data}
    ...
    output_file = "data/Amery_data.h5"

    time = time.strftime("%m%d%H%M")
    full_data_dict["metadata"] = {"time": time, "data_path": "data/original_amery.mat", "experiment_name": "visc_inv_Amery", "data_source": "10.1126/science.adp3300"}
