...
if __name__ == "__main__":
    data = loadmat("data/original_ross.mat")
    ...
    output_file = "data/Ross_data.h5"

    time = time.strftime("%m%d%H%M")
    full_data_dict["metadata"] = {"time": time, "data_path": "data/original_ross.mat", "experiment_name": "visc_inv_Ross", "data_source": "10.1126/science.adp3300"}
